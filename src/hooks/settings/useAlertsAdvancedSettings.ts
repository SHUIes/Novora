...
import { getAppSettings, updateAppSettings, updateAlertsSettings, APP_SETTINGS_KEY } from '../../utils/appSettings';
...
export function useAlertsAdvancedSettings() {
  ...
  const [silentMode, setSilentMode] = useState<'all' | 'keyOnly' | 'pauseUntilExamEnd'>(
