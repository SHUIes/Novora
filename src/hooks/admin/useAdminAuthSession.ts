...
import { getAdminUser, shouldPromptGradeAdminSetup, type AdminUserContext } from '../../services/examService';
...
export function useAdminAuthSession() {
  ...
  const [currentDeviceBinding, setCurrentDeviceBinding] = useState(() => getCachedDeviceBinding() ?? null);
