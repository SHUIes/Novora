      ...
      <section className="plugin-connect__panel" aria-live="polite">
        {complete ? (
          ...
          <>
            ...
            {bindingValid ? (
              <div className="plugin-connect__binding">
                <span>跟随看板班级</span>
                <strong>{binding.classTag}</strong>
              </div>
            ) : (
            ...
            <button type="button" disabled={!info || !bindingValid || submitting} onClick={() => void confirm()}>
