        ...
        {state === 'unset' ? (
          <>
            ...
            <p className="consent-lead">
              本应用会收集<strong>匿名部署与运行遥测</strong>（实例标识、版本、主机名、时区、语言、大致地区、匿名化 IP
              哈希），用于统计部署数量与版本分布。<u>不会收集任何考试内容或个人身份信息。</u>
            </p>
            ...
            <div className="consent-actions">
              <button className="consent-btn consent-btn--ghost" onClick={decline}>
                不同意
              </button>
              <button className="consent-btn consent-btn--primary" onClick={agree}>
                同意并继续
              </button>
            </div>
          </>
          ...
          <>
            ...
            <div className="consent-actions">
              <button className="consent-btn consent-btn--primary" onClick={reconsider}>
                重新考虑
              </button>
            </div>
          </>
